...
func TestCausalOrder_Linear(t *testing.T) {
	...
	events := []Event{
		{ID: "evt_C", WorkItemID: "wrk_1", ParentEventIDs: []EventID{"evt_B"}, Timestamp: t0.Add(2 * time.Second)},
		{ID: "evt_A", WorkItemID: "wrk_1", ParentEventIDs: nil, Timestamp: t0},
		{ID: "evt_B", WorkItemID: "wrk_1", ParentEventIDs: []EventID{"evt_A"}, Timestamp: t0.Add(1 * time.Second)},
	}
...
func TestCausalOrder_Diamond(t *testing.T) {
	t0 := time.Date(2026, 1, 1, 0, 0, 0, 0, time.UTC)
	events := []Event{
		{ID: "evt_D", WorkItemID: "wrk_1", ParentEventIDs: []EventID{"evt_B", "evt_C"}, Timestamp: t0.Add(3 * time.Second)},
		{ID: "evt_B", WorkItemID: "wrk_1", ParentEventIDs: []EventID{"evt_A"}, Timestamp: t0.Add(1 * time.Second)},
		{ID: "evt_C", WorkItemID: "wrk_1", ParentEventIDs: []EventID{"evt_A"}, Timestamp: t0.Add(2 * time.Second)},
		{ID: "evt_A", WorkItemID: "wrk_1", ParentEventIDs: nil, Timestamp: t0},
	}
...
func TestCausalOrder_ConcurrentTiebreak(t *testing.T) {
	t0 := time.Date(2026, 1, 1, 0, 0, 0, 0, time.UTC)
	events := []Event{
		{ID: "evt_Z", WorkItemID: "wrk_1", ParentEventIDs: []EventID{"evt_A"}, Timestamp: t0.Add(1 * time.Second)},
		{ID: "evt_A", WorkItemID: "wrk_1", ParentEventIDs: nil, Timestamp: t0},
		{ID: "evt_M", WorkItemID: "wrk_1", ParentEventIDs: []EventID{"evt_A"}, Timestamp: t0.Add(1 * time.Second)},
	}
...
func TestCausalOrder_Single(t *testing.T) {
	events := []Event{{ID: "evt_A", WorkItemID: "wrk_1", Timestamp: time.Now()}}
	ordered := CausalOrder(events)
